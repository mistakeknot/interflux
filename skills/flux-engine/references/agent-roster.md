...
If no Project Agents exist AND Codex mode is active (formerly "interserve mode"), flux-drive will bootstrap them via Codex (see `phases/launch-codex.md`). If no Project Agents exist and Codex mode is NOT active, skip this category entirely.
